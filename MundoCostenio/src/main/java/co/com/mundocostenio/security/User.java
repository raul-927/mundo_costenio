...
public class User /* extends org.springframework.security.core.userdetails.User */{
	 ...
	 */
	/*
	 * private static final long serialVersionUID = 1L; private String lastname;
	 * private int age;
	 * 
	 ...
	 * credentialsNonExpired, accountNonLocked, authorities); this.lastname =
	 * lastname; this.age=age; }
	 * 
	 * public User(String username, String password, Collection<? extends
	 * GrantedAuthority> authorities, String lastname, int age) { this(username,
	 * password, true, true, true, true, authorities, lastname,age); }
	 * 
