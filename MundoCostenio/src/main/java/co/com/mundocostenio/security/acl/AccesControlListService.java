...
public class AccesControlListService<T> {
	...
	public int insert(T object) {
		...
		if(object instanceof Post) {
            ...
            mutableAcl.insertAce(1, BasePermission.DELETE, new GrantedAuthoritySid(RolesEnum.ADMIN.getDescripcion().toString()), true);
            mutableAcl.insertAce(2, BasePermission.READ, new GrantedAuthoritySid(RolesEnum.ADMIN.getDescripcion().toString()), true);
            mutableAcl.insertAce(3, BasePermission.READ, new GrantedAuthoritySid(RolesEnum.USER.getDescripcion().toString()), true);
